...
const cart = () => {
    ...
    if (cartTable && cameraInCart) {
        Object.values(cameraInCart).map(camerasInCart => {
            ...
            cartTable.innerHTML += "<tr><td><img class='d-none d-md-inline w-25 px-2' src=" + camerasInCart.image + ">" + camerasInCart.name + 
            "</td><td class='text-center'>" + camerasInCart.price + 
